...
import com.smc.cad3d.model.Cad3dForm;
import com.smc.cad3d.service.Cad3dFormValidator;
import com.smc.cad3d.service.Cad3dServiceImpl;
...
@Controller
@Slf4j
@RequestMapping("/login/admin/cad3d")
@SessionAttributes(value= {"SessionScreenState", "SessionUser"})
public class Cad3dController extends BaseController {


	@Autowired
	Cad3dServiceImpl service;

	@Autowired
	Cad3dFormValidator validator;
	...
	private final String DIR="/tmp/smccad_data";
	...
	public ModelAndView list(
			ModelAndView mav,
			@ModelAttribute("cad3dForm") Cad3dForm myform,
		...
		mav.setViewName("/login/admin/cad3d/index");
	...
	public ModelAndView post(
			...
			@Validated @ModelAttribute("cad3dForm") Cad3dForm form,
			BindingResult result) {
		// XXX BindingResultは@Validatedの直後の引数にする

		// Set view
		mav.setViewName("/login/admin/cad3d/result");
		...
		if (!result.hasErrors()) {
            ...
            String fullpath = dir+"/"+"cad3d_"+form.getLang()+".csv";
